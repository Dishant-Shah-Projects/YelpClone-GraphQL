...
class RestaurantSignup extends Component{
    ...
    submit = (e) => {
        ...
        axios.post('http://localhost:3001/restaurantsignup',data)
            .then(response => {
                ...
                <div className="login-form">
                    <div className="main-div">
                        ...
                        <div className="form-group">
                         ...
                         <div className="form-group">
                                <input onChange = {this.locationChangeHandler} type="text" className="form-control" name="location" placeholder="Email" required/>
                            </div>
                            {this.state.usererr  &&
                            <div className="alert alert-danger">{this.state.usererr}</div>
                        }
